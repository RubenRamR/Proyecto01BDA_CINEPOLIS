...
public class SucursalesDAO implements ISucursalesDAO {
    ...
    public double[] obtenerCoordenadasSucursal(String nombreSucursal) {
        ...
        try (Connection conn = conexionBD.obtenerConexion();
             PreparedStatement pstmt = conn.prepareStatement("SELECT ubicacion FROM sucursales WHERE nombre = ?")) {
    ...
    public List<String> obtenerNombreSucursales() {
        ...
        try (Connection conn = conexionBD.obtenerConexion();
             PreparedStatement pstmt = conn.prepareStatement("SELECT nombre FROM sucursales");
             ResultSet rs = pstmt.executeQuery()) {
            while (rs.next()) {
